...
const exp = [
  {
    ...
    cardImage: "assets/images/experience-page/Meijer-Logo-500x281.jpg",
    place: "Remote, USA",
    time: "(Jan, 2024 - April, 2024)",
    desp: "<li> Optimized on-shelf availability (OSA) to enhance customer experience by developing a predictive LSTM model integrating into Power BI, empowering categorical managers and merchandisers to dynamically adjust strategies.</li>",
  },
  {
